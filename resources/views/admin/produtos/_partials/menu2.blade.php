<div class=" flex justify-center items-center">
                    ...
                    <button><a class="y-2 px-4 font-semibold rounded-lg shadow-md text-white bg-yellow-500 hover:bg-yellow-700 nav-link disabled ml-3.5" href="{{route('produtos.peixes')}}">Peixes</a>
                    </button>
