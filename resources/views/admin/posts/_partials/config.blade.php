...
<ul class="space-y-6 container mx-auto px-4 lg:ml-96">
  <li class="text-white">Nome</li>
  <input class="rounded-xl border text-white bg-green-500 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent  lg:ml-30 lg:w-96" type="text" ><button class="ml-3 py-2 px-4 font-semibold rounded-lg shadow-md text-white bg-blue-500 hover:bg-blue-700" >Salvar</button>
  <li class="text-white">Negócio</li>
  <input class="rounded-xl border text-white bg-green-500 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent  lg:ml-30 lg:w-96" type="text"><button class="ml-3 py-2 px-4 font-semibold rounded-lg shadow-md text-white bg-blue-500 hover:bg-blue-700">Salvar</button>
  <li class="text-white">Email</li>
  <input class="rounded-xl border text-white bg-green-500 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent  lg:ml-30 lg:w-96" type="text"><button class="ml-3 py-2 px-4 font-semibold rounded-lg shadow-md text-white bg-blue-500 hover:bg-blue-700">Salvar</button>
  <li class="text-white">Senha</li>
  <input class="rounded-xl border text-white bg-green-500 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent  lg:ml-30 lg:w-96" type="text"><button class="ml-3 py-2 px-4 font-semibold rounded-lg shadow-md text-white bg-blue-500 hover:bg-blue-700">Salvar</button>
</ul>
</form>
<ul>
